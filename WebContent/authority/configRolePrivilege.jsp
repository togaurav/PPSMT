...
<input name="role_id" value="${roleId}" type="hidden" />
<input name="user_id" value="${session.userId}" type="hidden" />
<table>
	<tr>
	...
	<tr style="background-color: transparent;" class="privilege_item data_rows">
		<td>
			<label for="item_id_<s:property value="#privileges.id" />">
				<input name="privileges[]" value="<s:property value="#privileges.id" />" id="item_id_<s:property value="#privileges.id" />" class="privilege_cate_<s:property value="#cate.id" />" type="checkbox">
